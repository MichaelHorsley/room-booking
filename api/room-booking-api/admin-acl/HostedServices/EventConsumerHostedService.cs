...
namespace admin_acl.HostedServices;
...
public class EventConsumerHostedService : IHostedService
{
    ...
    {
        _logger.LogInformation("Admin ACL Consumer Service is starting up");
    ...
    {
        var viewModelProjectionTypes = Assembly.GetAssembly(typeof(HostAntiCorruptionLayer))
            .GetTypes()
        ...
        foreach (var viewModelProjectionType in viewModelProjectionTypes)
        {
            ...
            var queue = $"admin-acl-{projectTypeName}";
